...
def main():
    ...
    try:
        ...
        if st.sidebar.button("更新所有提示词"):
            st.write("更新前的提示词：", st.session_state.prompt_templates.get_template('requirement_analyst'))
            ...
            st.write("更新后的提示词：", st.session_state.prompt_templates.get_template('requirement_analyst'))
        ...
        if uploaded_file is not None:
            try:
                ...
                if analyze_button:
                    ...
                    # 验证提示词是否正确传递
                    st.write("当前使用的提示词：")
                    st.write("需求分析师角色设定：", st.session_state.prompt_templates.get_template('requirement_analyst'))
                    st.write("需求分析任务说明：", st.session_state.prompt_templates.get_template('requirement_task'))
