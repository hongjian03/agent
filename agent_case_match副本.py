...
TAG_SYSTEM = {
    ...
    "businessCapabilities": [
        "名校专家", "博士专家", "低龄留学专家", "跨国家线专家", "跨专业专家"
    ],
    
    "serviceQualities": [
        "offer猎手", "签证能手", "高效文案", "口碑文案"
    ],
    
    "stability": [
        "专家Lv. 6+", "资深Lv. 3+", "熟练Lv. 1+"
    ]
}
# 添加新的配置类来管理提示词模板
...
def extract_tags_task(step_callback):
    ...
    return Task(
        ...
        3. 业务能力标签 (businessCapabilities)
        - 申请国家跨两个及以上区域，输出"跨国家线专家"
        - 毕业专业与申请专业跨大类，输出"跨专业专家"
        - 名校占比≥0.6，输出"名校专家"
        - 申请博士或研究型硕士，输出"博士专家"
        - 申请K12项目，输出"低龄留学专家"
        
        4. 服务质量标签 (serviceQualities)
        - 特殊要求中提及申请服务需求，输出"申请能手"
        - 特殊要求中提及签证服务需求，输出"签证能手"
        - 期待尽快进入申请审理阶段为"是"，输出"高效文案"
        - 美加申请距截止≤2个月或其他地区≤1个月，输出"高效文案"
        - 客户调查"是"的数量≥4且有特殊要求，输出"口碑文案"和"好评文案"
        - 客户调查"是"的数量≥4或有特殊要求，输出"好评文案"
        
        5. 熟练度水平标签 (stability)
        - 特殊要求中提及稳定性/经验要求，仅输出"专家Lv. 6+"
        - 申请者来自顶尖院校(C9/藤校/G5等)或跨专业申请，输出"资深Lv. 3+"和"专家Lv. 6+"
        - 其他情况输出"熟练Lv. 1+"、"资深Lv. 3+"和"专家Lv. 6+"
        """,
